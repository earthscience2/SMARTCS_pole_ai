...
def get_pole_anal_result_in(poleid, measno, in_hall_height, in_insert_len, in_st_angle, thr_val=None):
    ...
    # print(pole_data_x.head())
    # print(pole_data_y.head())
    # print(pole_data_z.head())
    # print(Pole_IN_DataSet_Name)
    ...
    # print(Pole_IN_DataSet_list[0].columns.tolist())
...
def get_pole_vector_data(poleid, dtype, measno, anal_dir, stdegree, eddegree, stheight, edheight, thr_over=None, scale=None):
    ...
    for i,c in enumerate(coords):
        ...
        '''
        vector = go.Scatter3d(y = [X1[0],X2[0]],
                                x = [Y1[0],Y2[0]],
                                z = [Z1[0],Z2[0]],
...
if __name__ == '__main__':
    ...
    # d = get_pole_3d_data('1001A011', 'OUT', 2, 'detrend', 5000)
    # d = get_pole_3d_data('1001A011', 'OUT', 2, 'GdotD', 5000)
    # print(d)
    ...
    d = pole_simulation(Main_mag_s, Sub_mag_s, Ga_mag_s, HallSensor_h)
    '''
