#!/bin/bash
# WSL2에서 TensorFlow GPU를 사용해 Hard 1st-stage bbox 모델 평가(11. evaluate_hard_model_1st.py)
...
echo "Hard 1st-stage bbox 모델 평가 시작..."
python3 "make_ai/11. evaluate_hard_model_1st.py" --local "$@"
